...
const AboutUs = () => {
    return (
       <section className="py-20 bg-white/10 my-12 rounded-2xl text-white">
...
A modern platform built for organizations that value efficiency, compliance, and clarity.
</p>
</motion.div>
